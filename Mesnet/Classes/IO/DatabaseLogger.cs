...
namespace Mesnet.Classes.IO
{
    public class DatabaseLogger
    {
        static DatabaseLogger()
        {
            ...
            ThreadPool.SetMaxThreads(Config.MaxDatabaseLoggerThreadCount, minIOC);

            SQLiteConnection.CreateFile(Config.DatabaseLoggerDbName);

            _connection = new SQLiteConnection("Data Source=" + Config.DatabaseLoggerDbName + ";MesnetVersion=3;");
            _connection.Open();
