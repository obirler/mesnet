...
namespace Mesnet.Classes.Math
{
    public class TPolygon
    {
        ...
        public float PolygonArea()
        {
            ...
            // oriented clockwise.
            return System.Math.Abs(SignedPolygonArea());
        }
        ...
        private bool FindIntersection(float X1, float Y1, float X2, float Y2, float A1, float B1, float A2, float B2, ref PointF intersect)
        {
            ...
            if (System.Math.Abs(da * dy - db * dx) < 0.001) return false;
