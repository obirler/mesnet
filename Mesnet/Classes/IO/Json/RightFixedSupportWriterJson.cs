...
{
    public class RightFixedSupportWriterJson
    {
        public RightFixedSupportWriterJson(JsonWriter writer, RightFixedSupport support)
        {
            _writer = writer;
        ...
        public void Write()
        {
            _writer.WritePropertyName("RightFixedSupport");
        ...
        private RightFixedSupport _support;
    }
}
